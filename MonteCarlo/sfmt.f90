...
subroutine rshift128(outTop, outBtm, inTop, inBtm, shift)
    implicit none
    integer(kind=8),intent(out):: outTop, outBtm
    integer(kind=8),intent(in):: inTop, inBtm
    integer:: shift
!   integer(kind=8):: th, tl, oh, ol;
...
subroutine do_recursion(rTop, rBtm, aTop, aBtm, bTop, bBtm, cTop, cBtm, dTop, dBtm)
    ...
    integer(kind=8),intent(out):: rTop, rBtm
    integer(kind=8),intent(in):: aTop, aBtm, bTop, bBtm, cTop, cBtm, dTop, dBtm
!    w128_t x;
!    w128_t y;
    integer(kind=8):: xTop, xBtm, yTop, yBtm
...
subroutine gen_rand_all()
    ...
    integer:: i
    integer(kind=8):: r1Top, r1Btm, r2Top, r2Btm
    ...
    do i=0,N - POS1 - 1
        ...
        call do_recursion(psfmt64(i*2 + 1),psfmt64(i*2), psfmt64(i*2 + 1),&
             psfmt64(i*2), psfmt64((i + POS1)*2+1), &
             psfmt64((i + POS1)*2), r1Top, r1Btm, r2Top, r2Btm);
        r1Btm = r2Btm
        r1Top = r2Top
        r2Btm = psfmt64(i*2)
        r2Top = psfmt64(i*2 + 1)
...
! */
integer(kind=4) function gen_rand32()
    use MOD_SFMT
    implicit none
...
! */
integer(kind=8) function gen_rand64()
    use MOD_SFMT
    implicit none
    integer::i
...
real(kind=8) function genrand_res53() 
!    integer(kind=8):: gen_rand64
    integer(kind=8):: i
    i = gen_rand64()
    i = ishft(i, -1)
