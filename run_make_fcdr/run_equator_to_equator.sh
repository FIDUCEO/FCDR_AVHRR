...
echo python2.7 run_equator_to_equator.py NOAA06 >> run.1.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.2.sh
echo python2.7 run_equator_to_equator.py NOAA07 >> run.2.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.3.sh
echo python2.7 run_equator_to_equator.py NOAA08 >> run.3.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.4.sh
echo python2.7 run_equator_to_equator.py NOAA09 >> run.4.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.5.sh
echo python2.7 run_equator_to_equator.py NOAA10 >> run.5.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.6.sh
echo python2.7 run_equator_to_equator.py NOAA11 >> run.6.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.7.sh
echo python2.7 run_equator_to_equator.py NOAA12 >> run.7.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.8.sh
echo python2.7 run_equator_to_equator.py NOAA14 >> run.8.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.9.sh
echo python2.7 run_equator_to_equator.py NOAA15 >> run.9.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.10.sh
echo python2.7 run_equator_to_equator.py NOAA16 >> run.10.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.11.sh
echo python2.7 run_equator_to_equator.py NOAA17 >> run.11.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.12.sh
echo python2.7 run_equator_to_equator.py NOAA18 >> run.12.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.13.sh
echo python2.7 run_equator_to_equator.py NOAA19 >> run.13.sh
echo '. /home/users/mtaylor/pyenv/pygac/bin/activate' > run.14.sh
echo python2.7 run_equator_to_equator.py METOPA >> run.14.sh
